...
async function bootstrap() {
  ...
  SwaggerModule.setup('api/orders/docs', app, SwaggerModule.createDocument(app,
    new DocumentBuilder().setTitle('FoodHub Order API').setVersion('1.0').addBearerAuth().build()));
